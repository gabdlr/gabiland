class GabiChatPresenter extends HTMLElement {
  ...
  render() {
    ...
    *, ::after, ::before {
    ...
    const headerTitle = this._elementBuilder.build<HTMLSpanElement>(
      "span",
      headerTitleClasses
    );
    headerTitle.innerText = CHAT_TITLE_TEXT;
    const headerCloseButtonClasses = ["chat-close"];
    const headerCloseButton = this._elementBuilder.build<HTMLSpanElement>(
      "span",
      headerCloseButtonClasses,
      [
    ...
    const bodyContainer = this._elementBuilder.build(
      "div",
    ...
    const footerFormContent = this._elementBuilder.build(
      "div",
      footerFormContentClasses
    );

    const footerFormContentInputChatInputClasses = ["form-control"];
    const footerFormContentInputChatInput =
      this._elementBuilder.build<HTMLInputElement>(
        "input",
        footerFormContentInputChatInputClasses,
        [
          this._elementBuilder.attributeFactory("id", "chatInput"),
          this._elementBuilder.attributeFactory(
            "placeholder",
    ...
    const footerFormContentButton =
      this._elementBuilder.build<HTMLButtonElement>(
        "button",
        footerFormContentButtonClasses
      );
    footerFormContentButton.type = "submit";

    const footerFormContentButtonSvg = this._elementBuilder.build<SVGElement>(
      "svg",
      void 0,
      [
    ...
    const footerFormContentButtonSvgGElArray =
      this._elementBuilder.buildCollection<SVGGElement>("g", void 0, void 0, 3);
    this._elementBuilder.assemble(
      footerFormContentButtonSvgGElArray[0],
      void 0,
      [
    ...
    this._elementBuilder.assemble(
      footerFormContentButtonSvgGElArray[1],
      void 0,
      [
    ...
    this._elementBuilder.assemble(
      footerFormContentButtonSvgGElArray[2],
      void 0,
      [this._elementBuilder.attributeFactory("id", "SVGRepo_iconCarrier")]
    );

    const footerFormContentButtonSvgThirdGElPath =
      this._elementBuilder.build<SVGPathElement>("path");
    this._elementBuilder.assemble(
    ...
    footerFormContentButtonSvgGElArray[2].appendChild(
      footerFormContentButtonSvgThirdGElPath
    );
    footerFormContentButtonSvgGElArray.forEach((el) =>
      footerFormContentButtonSvg.appendChild(el)
    );
  ...
  createMessageEl(text: string, isVisitor = true) {
    ...
    const messageIconWrapper = this._elementBuilder.build(
      "div",
      messageIconWrapperClasses
    );
    ...
    if (isVisitor) {
      ...
      const messageIconSvgPathElArray = this._elementBuilder.buildCollection(
        "path",
        void 0,
        void 0,
        6
      ...
      const messageIconSvgGElArray = this._elementBuilder.buildCollection(
        "g",
        void 0,
        void 0,
        3
      ...
      const messageIconSvgThirdGElFirstPathElArray =
        this._elementBuilder.buildCollection("path", void 0, void 0, 6);
      this._elementBuilder.assemble(
        messageIconSvgThirdGElFirstPathElArray[0],
        void 0,
        [
          this._elementBuilder.attributeFactory(
            "d",
      ...
      this._elementBuilder.assemble(
        messageIconSvgThirdGElFirstPathElArray[1],
        void 0,
        [
          this._elementBuilder.attributeFactory(
            "d",
      ...
      this._elementBuilder.assemble(
        messageIconSvgThirdGElFirstPathElArray[2],
        void 0,
        [
          this._elementBuilder.attributeFactory(
            "d",
      ...
      this._elementBuilder.assemble(
        messageIconSvgThirdGElFirstPathElArray[3],
        void 0,
        [
          this._elementBuilder.attributeFactory(
            "d",
      ...
      this._elementBuilder.assemble(
        messageIconSvgThirdGElFirstPathElArray[4],
        void 0,
        [
          this._elementBuilder.attributeFactory(
            "d",
      ...
      this._elementBuilder.assemble(
        messageIconSvgThirdGElFirstPathElArray[5],
        void 0,
        [
          this._elementBuilder.attributeFactory(
            "d",
      ...
      messageIconSvgThirdGElFirstPathElArray.forEach((path) =>
        messageIconSvgGElArray[2].appendChild(path)
      );

      const messageIconSvgThirdGElGELArray =
        this._elementBuilder.buildCollection("g", void 0, void 0, 4);
      this._elementBuilder.assemble(messageIconSvgThirdGElGELArray[0], void 0, [
        this._elementBuilder.attributeFactory("fill", "#ff639b"),
      ]);

      const messageIconSvgThirdGElFirstGElPathElArray =
        this._elementBuilder.buildCollection("path", void 0, void 0, 2);
      this._elementBuilder.assemble(
        messageIconSvgThirdGElFirstGElPathElArray[0],
        void 0,
        [
          this._elementBuilder.attributeFactory(
            "d",
      ...
      this._elementBuilder.assemble(
        messageIconSvgThirdGElFirstGElPathElArray[1],
        void 0,
        [
          this._elementBuilder.attributeFactory(
            "d",
      ...
      messageIconSvgThirdGElFirstGElPathElArray.forEach((path) =>
        messageIconSvgThirdGElGELArray[0].appendChild(path)
      );
      messageIconSvgGElArray[2].appendChild(messageIconSvgThirdGElGELArray[0]);

      const messageIconSvgThirdGElSecondPathElArray =
        this._elementBuilder.buildCollection("path", void 0, void 0, 3);
      this._elementBuilder.assemble(
        messageIconSvgThirdGElSecondPathElArray[0],
        void 0,
        [
          this._elementBuilder.attributeFactory(
            "d",
      ...
      this._elementBuilder.assemble(
        messageIconSvgThirdGElSecondPathElArray[1],
        void 0,
        [
          this._elementBuilder.attributeFactory(
            "d",
      ...
      this._elementBuilder.assemble(
        messageIconSvgThirdGElSecondPathElArray[2],
        void 0,
        [
          this._elementBuilder.attributeFactory(
            "d",
      ...
      const messageIconSvgThirdGElSecondGElPathElArray =
        this._elementBuilder.buildCollection("path", void 0, void 0, 3);
      ...
      messageIconSvgThirdGElSecondGElPathElArray.forEach((path) =>
        messageIconSvgThirdGElGELArray[1].appendChild(path)
      );
      messageIconSvgGElArray[2].appendChild(messageIconSvgThirdGElGELArray[1]);

      const messageIconSvgThirdGElPathElArray =
        this._elementBuilder.buildCollection("path", void 0, void 0, 2);
      messageIconSvgThirdGElPathElArray[0].setAttribute(
        "d",
      ...
      messageIconSvgGElArray[2].appendChild(
        messageIconSvgThirdGElPathElArray[0]
      );

      messageIconSvgThirdGElGELArray[2].setAttribute("fill", "#b2c1c0");
      const messageIconSvgThirdGElThirdGElPathElArray =
        this._elementBuilder.buildCollection("path", void 0, void 0, 2);
      ...
      messageIconSvgThirdGElThirdGElPathElArray.forEach((path) =>
        messageIconSvgThirdGElGELArray[2].appendChild(path)
      );
      ...
      const messageIconSvgThirdGElFourthGElPathElArray =
        this._elementBuilder.buildCollection("path", void 0, void 0, 2);
      ...
      messageIconSvgThirdGElFourthGElPathElArray.forEach((path) =>
        messageIconSvgThirdGElGELArray[3].appendChild(path)
      );
      messageIconSvgGElArray[2].appendChild(messageIconSvgThirdGElGELArray[3]);

      this._elementBuilder.assemble(
        messageIconSvgThirdGElPathElArray[1],
        void 0,
        [
          this._elementBuilder.attributeFactory("fill", "#b2c1c0"),
          this._elementBuilder.attributeFactory(
...
type BuilderHTMLElement =
  ...
  | SVGGElement
  | SVGPathElement;
type Attributes = { qualifiedName: string; value: string };
type ElementBuilder = {
  assemble(
    element: BuilderHTMLElement,
    classes?: string[],
    attributes?: Attributes[]
  ): BuilderHTMLElement;
  builders: {
    [key in BuilderSupportedElements]: { build(): BuilderHTMLElement };
  };
  build<T extends BuilderHTMLElement>(
    elementType: BuilderSupportedElements,
    classes?: string[],
    attributes?: Attributes[]
  ): T;
  buildCollection<T extends BuilderHTMLElement>(
    elementType: BuilderSupportedElements,
    classes?: string[],
    attributes?: Attributes[],
    qty?: number
  ): T[];
  attributeFactory(qualifiedName: string, value: string): Attributes;
};
